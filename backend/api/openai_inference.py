...
from backend.models.patient import CTAnalysis

router = APIRouter()
_openai_service = None

def _get_openai_service():
    """Lazy-load OpenAIService to avoid heavy import chain at startup"""
...
async def run_openai_inference(
    ...
    try:
        result = _get_openai_service().run_medical_inference(
...
@router.get("/analysis/{analysis_id}/compare")
